CREATE DATABASE  IF NOT EXISTS `pizza_runner` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `pizza_runner`;
-- MySQL dump 10.13  Distrib 8.0.30, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: pizza_runner
-- ------------------------------------------------------
...
INSERT INTO `customer_orders` VALUES (1,101,1,'','','2020-01-01 12:05:02'),(2,101,1,'','','2020-01-01 13:00:52'),(3,102,1,'','','2020-01-02 17:51:23'),(3,102,2,'',NULL,'2020-01-02 17:51:23'),(4,103,1,'4','','2020-01-04 07:23:46'),(4,103,1,'4','','2020-01-04 07:23:46'),(4,103,2,'4','','2020-01-04 07:23:46'),(5,104,1,'null','1','2020-01-08 15:00:29'),(6,101,2,'null','null','2020-01-08 15:03:13'),(7,105,2,'null','1','2020-01-08 15:20:29'),(8,102,1,'null','null','2020-01-09 17:54:33'),(9,103,1,'4','1, 5','2020-01-10 05:22:59'),(10,104,1,'null','null','2020-01-11 12:34:49'),(10,104,1,'2, 6','1, 4','2020-01-11 12:34:49');
/*!40000 ALTER TABLE `customer_orders` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `customer_orders_new`
--
...
--
-- Dumping data for table `customer_orders_new`
--

LOCK TABLES `customer_orders_new` WRITE;
/*!40000 ALTER TABLE `customer_orders_new` DISABLE KEYS */;
INSERT INTO `customer_orders_new` VALUES (1,101,1,NULL,NULL,'2020-01-01 12:05:02'),(2,101,1,NULL,NULL,'2020-01-01 13:00:52'),(3,102,1,NULL,NULL,'2020-01-02 17:51:23'),(3,102,2,NULL,NULL,'2020-01-02 17:51:23'),(4,103,1,'4',NULL,'2020-01-04 07:23:46'),(4,103,1,'4',NULL,'2020-01-04 07:23:46'),(4,103,2,'4',NULL,'2020-01-04 07:23:46'),(5,104,1,NULL,'1','2020-01-08 15:00:29'),(6,101,2,NULL,NULL,'2020-01-08 15:03:13'),(7,105,2,NULL,'1','2020-01-08 15:20:29'),(8,102,1,NULL,NULL,'2020-01-09 17:54:33'),(9,103,1,'4','1, 5','2020-01-10 05:22:59'),(10,104,1,NULL,NULL,'2020-01-11 12:34:49'),(10,104,1,'2, 6','1, 4','2020-01-11 12:34:49');
/*!40000 ALTER TABLE `customer_orders_new` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `runner_orders_new`
--
...
--
-- Dumping data for table `runner_orders_new`
--

LOCK TABLES `runner_orders_new` WRITE;
/*!40000 ALTER TABLE `runner_orders_new` DISABLE KEYS */;
INSERT INTO `runner_orders_new` VALUES (1,1,'2020-01-01 18:15:34',20.0,32,NULL),(2,1,'2020-01-01 19:10:54',20.0,27,NULL),(3,1,'2020-01-03 00:12:37',13.4,20,NULL),(4,2,'2020-01-04 13:53:03',23.4,40,NULL),(5,3,'2020-01-08 21:10:57',10.0,15,NULL),(6,3,NULL,NULL,NULL,'Restaurant Cancellation'),(7,2,'2020-01-08 21:30:45',25.0,25,NULL),(8,2,'2020-01-10 00:15:02',23.4,15,NULL),(9,2,NULL,NULL,NULL,'Customer Cancellation'),(10,1,'2020-01-11 18:50:20',10.0,10,NULL);
/*!40000 ALTER TABLE `runner_orders_new` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-29  2:51:31
